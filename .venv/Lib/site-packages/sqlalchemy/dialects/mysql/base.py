...
class MySQLDialect(default.DefaultDialect):
    ...
    def _support_float_cast(self) -> bool:
        if not self.server_version_info:
            ...
            # ref https://mariadb.com/kb/en/mariadb-1045-release-notes_service/
            return self.server_version_info >= (10, 4, 5)
        else:
            # ref https://dev.mysql.com/doc/relnotes_service/mysql/8.0/en/news-8-0-17.html#mysqld-8-0-17-feature  # noqa
    ...
    def _support_default_function(self) -> bool:
        if not self.server_version_info:
            ...
            # ref https://mariadb.com/kb/en/mariadb-1021-release-notes_service/
