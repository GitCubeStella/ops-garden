...
class Unicode(String):
    ...
    encoding should be configured as detailed in the notes_service for the target DBAPI
...
class JSON(Indexable, TypeEngine[Any]):
    ...
    .. note::  :class:`_types.JSON`
       ...
       * MySQL - see
         :class:`sqlalchemy.dialects.mysql.JSON` for backend-specific notes_service

       * SQLite as of version 3.9 - see
         :class:`sqlalchemy.dialects.sqlite.JSON` for backend-specific notes_service

       * Microsoft SQL Server 2016 and later - see
         :class:`sqlalchemy.dialects.mssql.JSON` for backend-specific notes_service
